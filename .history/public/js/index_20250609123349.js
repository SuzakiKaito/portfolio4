document.querySelector('.skillMenu').addEventListener('click', (e) => {
  ...
  <ul style="list-style: none; padding: 0;">
    <li style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
      <img src="img/engneer.png" alt="Engineer Skill" style="width: 80px; margin-right: 1.5rem;">
      <div>
        <strong style="display: block; font-size: 1.6rem; margin-bottom: 0.5rem;">フロントエンド実装</strong>
        HTML、CSS、JavaScriptを用いたWebサイト、LPの扱いに慣れており、デザインに沿った実装が可能です。
      </div>
    </li>
    <li style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
      <img src="img/design.png" alt="Design Skill" style="width: 80px; margin-right: 1.5rem;">
      <div>
        <strong style="display: block; font-size: 1.6rem; margin-bottom: 0.5rem;">ビジュアルデザイン</strong>
        Adobe Illustrator、Adobe Photoshop、Figmaの操作方法を学び、各種デザイン制作（ロゴ、バナー、ポスター、ワイヤーフレーム、カンプ）に関する知識を身につけました。
      </div>
    </li>
    <li style="display: flex; align-items: flex-start;">
      <img src="img/plan.png" alt="Planning Skill" style="width: 80px; margin-right: 1.5rem;">
      <div>
        <strong style="display: block; font-size: 1.6rem; margin-bottom: 0.5rem;">課題発見と企画提案</strong>
