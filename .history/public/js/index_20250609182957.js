...
function showSkillSection() {
  workContent.innerHTML = skillSectionHTML;
  workContent.style.height = '100vh';  // ← ここで高さを100vhに変更
}

function showWorkContent() {
  workContent.innerHTML = ''; // or 元のコンテンツをセット
  workContent.style.height = '200vh'; // 元に戻す例
}
