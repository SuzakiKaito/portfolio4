...
//   const workContent = document.querySelector(".workContent");
//   const projectContent = workContent.querySelectorAll(".opus");
//   const futureContent = workContent.querySelector(".futureContent");

//   // プロジェクト内容を非表示に
//   projectContent.forEach(el => el.style.display = "none");
...
// document.querySelector('.topMenu a[href="#top"]').addEventListener('click', (e) => {
//   e.preventDefault();
//   const workContent = document.querySelector('.workContent');
//   workContent.innerHTML = `
//     <div class="opus"></div>
...
// index.js 例: 各メニュークリック時に表示切り替え
const opusContainer = document.querySelector('.opusContainer');
const skillContent = document.querySelector('.skillContent');
const futureContent = document.querySelector('.futureContent');

document.querySelector('.skillMenu').addEventListener('click', e => {
  e.preventDefault();
  opusContainer.style.display = 'none';
  skillContent.style.display = 'block';
  futureContent.style.display = 'none';
});

document.querySelector('.futureMenu').addEventListener('click', e => {
  e.preventDefault();
  opusContainer.style.display = 'none';
...
document.querySelector('.topMenu').addEventListener('click', e => {
  e.preventDefault();
  opusContainer.style.display = 'block';
  skillContent.style.display = 'none';
  futureContent.style.display = 'none';
});
